...
public class AsignacionController {
    ...
    // Mostrar formulario para asignar instructor - RUTA CAMBIADA
    ...
    public String mostrarFormulario(@PathVariable("id") Long claseId, Model model) {
        ...
        return "asignar-instructor"; // Nombre del archivo HTML sin extensión
    }
    
    // Procesar el formulario - RUTA CAMBIADA
    ...
    public String procesarAsignacion(
        ...
        // Redirigir con mensaje de éxito - RUTA CAMBIADA
    ...
    private Object crearClaseEjemplo(Long id) {
        return new Object() {
            ...
            public String getNombre() { return "Tecnica de velocidad"; }
